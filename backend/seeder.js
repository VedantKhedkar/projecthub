  ...
  try {
    ...
    for (let i = 0; i < 20; i++) {
      projects.push({
        ...
        price: Math.floor(Math.random() * (15000 - 2000) + 2000),
        description: `This is a premium ${categories[i % categories.length]} project. It includes full source code and responsive design.`,
